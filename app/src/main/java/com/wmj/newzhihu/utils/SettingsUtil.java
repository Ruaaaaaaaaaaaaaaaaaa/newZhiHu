...
public class SettingsUtil {
    ...
    public static final String SP_CURRENT_SIZE = "current_text_size";
    ...
    public static boolean getOnlyWifiLoadImg(Context ctx) {
        return SpUtil.getBooleanByPreferenceManager(ctx, SP_ONLY_WIFI_LOAD_IMG, false);
    }
...
//    }
     ...
     * 是否为大字体
     */
    public static boolean getTextSize(Context ctx) {
        return SpUtil.getBooleanByPreferenceManager(ctx, SP_CURRENT_SIZE, false);
    }
...
//    }
    ...
    public static boolean getNoImageState(Context context) {
        return SpUtil.getBooleanByPreferenceManager(context, SP_NO_IMAGE,false);
    }
